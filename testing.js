  ...
  return inquirer.prompt([
    {
      type: "input",
      name: "managerName",
      message: "Welcome to your Team builder Mr/Ms. Manager! Please enter your name to begin",
    },
    {
      type: "input",
      name: "managerEmail",
...
function whatToDo () {
  inquirer.prompt ([
    ...
    choices: ["Engineer", "Intern", "generateHTML"],
  },
...
// .then(answers => {
//     const Mang = new Employee (answers.managerName,answers.managerEmail, answers.empID, answers.managerNumber);
//     teamArray.push(Mang);
//     whatToDo(); 
// }
